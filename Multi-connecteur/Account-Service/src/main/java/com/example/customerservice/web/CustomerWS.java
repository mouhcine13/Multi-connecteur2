...
@WebServiceClient(name = "CustomerWS",
                  wsdlLocation = "file:/C:/Users/youssef/Desktop/Multi-Connecteurs/Account-Service/src/main/resources/CustomerService.wsdl",
...
public class CustomerWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/youssef/Desktop/Multi-Connecteurs/Account-Service/src/main/resources/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/youssef/Desktop/Multi-Connecteurs/Account-Service/src/main/resources/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
